...
<div>
 ...
 <div><font size="10" color="CC9933">SMETANA LUXURY SUITE</font></div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/45.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/46.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/47.jpg"  width="460" height="345" id="one">
      </div>
    
	<div class="item">
        <img src="images/48.jpg"  width="460" height="345" id="one">
      </div>
	</div>
...
<br>
 ...
 <div>
   ...
   Our one-bedroom Smetana Luxury Suite is perfect for those looking for<br>
   luxurious comfort with a touch of tranquility in the heart of Prague. This<br>
   Luxury Suite features an impressive entrance, a vaulted ceiling with <br>
   windows, a grand king-sized bedroom and comfortable living room with a<br>
   fully equipped kitchenette. The oversized walk-in closet and dressing area<br>
   allow more-than-ample space to store all of your holiday purchases. This<br>
   Luxury Suite is NON-SMOKING.<br><br>

  Location : 4th floor<br><br>

  View : Vaulted Ceiling with Windows<br><br>
  ...
  telephone, minibar, large sofa, dining table, Illy coffee maker and two<br>
  closets<br><br>
