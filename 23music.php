...
<div>
 ...
 <div><font size="10" color="CC9933">MUSIC LIBRARY AND CONCIERGE</font></div>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/80.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/81.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/82.jpg"  width="460" height="345" id="one">
      </div>
	  
       <div class="item">
        <img src="images/83.jpg"  width="460" height="345" id="one">
      </div>
...
<br>
 ...
 The Aria Hotel Prague’s large selection of CDs, DVDs, videos and music<br>
 literature spans every music genre and is guarenteed to satisfy the tastes<br>
 of all music lovers. Guests can view and listen to their selections in the<br>
 Library, seated in our comfortable leather chairs, on our high-definition LCD<br>
 screen, or in the privacy and comfort of their own room or suite.<br><br>

Our Concierge and Music Director, Dr. Ivana Stehlikova, and her team are<br>
 entirely dedicated to your every wish, and no effort is spared to make your<br>
 stay at Aria Hotel Prague unforgettable
 </font>
   </div>
 </div>
