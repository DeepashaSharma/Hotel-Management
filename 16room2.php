...
<div>
 ...
 <div><font size="10" color="CC9933">JUNIOR SUITES</font></div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/32.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/33.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/34.jpg"  width="460" height="345" id="one">
      </div>
	  
      <div class="item">
      <img src="images/35.jpg"  width="460" height="345" id="one">
      </div>

	  <div class="item">
      <img src="images/36.jpg"  width="460" height="345" id="one">
      </div>
	</div>
...
<br>
 ...
 <div>
   ...
   Even more spacious than the Deluxe Rooms, our most popular rooms<br>
   offer a perfect balance of luxury and space. The Junior Suites are<br>
   decorated in varying colors and have an elegantly residential feel. The<br>
   double-glazed windows offer spectacular views of the Winter Garden<br>
   Atrium. All Junior Suites are NON-SMOKING.<br><br>

  Location : Throughout the hotel<br><br>

  View : Winter Garden Atrium<br><br>

  Decor : Tones of celadon, yellow and romantic red, inspired by Italian design<br><br>

  Beds : King, Queen or Twin<br><br>

  Bathrooms : One bathroom with bathtub, stand-up and rain shower, <br>
  Molton Brown toiletries, make-up mirror, hair dryer, bathroom telephone,<br>
  luxurious terrycloth bathrobes and slippers<br><br>
 ...
 telephone, minibar, large sofa and coffee table<br><br>

 Size : 33 - 42m2 / 355 - 452ft2
