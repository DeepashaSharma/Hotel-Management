  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/126.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/127.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/128.jpg"  width="460" height="345" id="one">
      </div>
...
<br><br>
 ...
 <font face="times new roman" size="9" color="CC9933">Room Details</font><br><br> 
 ...
 <tr>
    <th>Name</th>  <th>Room No.</th>   <th>Room type</th>   <th>No of persons</th>
	<th>Checkin</th>  <th>Checkout</th>   <th>Reg. date</th>   <th>Reg. price</th>
 </tr>	
 <?php
   if(isset($_POST['submit']))
  {

  $query=mysql_query("SELECT * FROM roombook");
  while($result=mysql_fetch_array($query))
  {
	  ...
	  <td><?php echo $result['r_type'];?></td>
	  <td><?php echo $result['no_of_person'];?></td>
