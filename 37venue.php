...
<div>
 ...
 <div><font size="10" color="CC9933">VENUE</font></div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/73.jpg"  width="460" height="345" id="one">
      </div>
      ...
      <div class="item">
        <img src="images/111.jpg"  width="460" height="345" id="one">
      </div>
...
Guests can enjoy screenings or performances from the Aria's extensive<br>
 Music Library in our private Screening Room equipped with an 80" LCD flat <br>
 screen with full HD and integrated Internet connection.<br><br>

With seating up to 50 people in "theatre style" or 26 in a U-shape, the <br>
Screening Room features state-of-the-art technology including Wilson <br>
speakers. The Screening Room is available for personal entertainment<br>
 purposes or for business functions.<br><br>

A multimedia XBOX One console, including Kinect and racing wheel, is also <br>
available upon request.<br><br>

Sound format: LOGIC7®, Dolby® Digital, Dolby Pro Logic II a Dolby Pro<br>
 Logic, dts® a dts-ES (discrete & matrix), THX Surround EX™, zvukový <br>
 systém Wilson Audio 7.1<br><br>

Front speakers: Wilson Audio Sophia (winner in category Absolute Sound -<br>
 Golden Ear in 2003, Stereophile: Editor’s Choice in 2002)<br><br>

Surround speakrs: Wilson Audio Watch<br><br>

Surround subwoofer: Wilson Audio Watch Dog ("Subwoofer of the Year<br>
 " 2002 - The Perfect Vision)<br><br>
