<?php
  ...
  {	 
	...
	$sql = mysql_query("INSERT INTO medserv(room_no, disease, date, charge)
	VALUES ('$a','$b','$c','$d')");
	 if($sql)
	 {  
    ...
    <!-- Wrapper for slides -->
	 <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/157.jpg"  width="80%" height="30%" id="one">
      </div>

      <div class="item">
        <img src="images/158.jpg" width="80%" height="30%" id="one">
      </div>
...
<div class="col-md-4"></div>
 ...
 <form action="" method="POST">
  <font face="times new roman" size="9" color="CC9933">Medical Services</font><br><br>
 ...
 <div> <div class="col-md-3"><font face="time new roman" size="4px">Disease</font></div>    <div><input type="text" placeholder="Enter disease" name="dss" required></div>         </div><br>
