<?php
  ...
  {	 
	...
	$sql = mysql_query("INSERT INTO laundserv(room_no, nclothes, date, charge)
	VALUES ('$a','$b','$c','$d')");
	 if($sql)
	 {  
    ...
    <!-- Wrapper for slides -->
	 <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/124.jpg"  width="80%" height="30%" id="one">
      </div>

      <div class="item">
        <img src="images/125.png" width="80%" height="30%" id="one">
      </div>
	  
      <div class="item">
        <img src="images/147.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/148.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/149.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/150.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/151.jpg" width="80%" height="30%" id="one">
      </div>
...
<div class="col-md-4"></div>
 ...
 <form action="" method="POST">
  ...
  <font face="times new roman" size="9" color="CC9933">Laundary services</font><br><br>
 ...
 <div> <div class="col-md-3"><font face="time new roman" size="4px">No of clothes</font></div>    <div><input type="text" placeholder="Enter no of clothes" name="noc" required></div>        </div><br>
 ...
 <div> <div class="col-md-3"><font face="time new roman" size="4px">Charge</font></div>    <div><input type="text" placeholder="Enter charge" name="chrg" required></div>                      </div><br>
  <div class="col-md-6"><center><input type="submit" value="Save" name="submit"></center></div> 
 </form>
</div>
</div>
