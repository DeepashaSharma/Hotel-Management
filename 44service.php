<?php
  ...
  {	 
	...
	$sql = mysql_query("INSERT INTO service(name, room_no, servreq, date)
	VALUES ('$a','$b','$c','$d')");
	 if($sql)
	 {  
	  echo "<script type='text/javascript'>
       alert('Your required service is available within few minutes!!!!!!!!!!');
	   </script>";
...
<div class="col-md-4"></div>
 <div class="col-md-6">
  ...
  <font face="times new roman" size="9" color="CC9933">Services</font><br><br>
     ...
     <div> <div class="col-md-3"><font face="time new roman" size="4px">Service Requested</font></div>   <div><input type="radio" name="srvce" value="room" required><font size=4%>Room Service</font><br>        
	                                                                                                          <input type="radio" name="srvce" value="laundary" required><font size=4%>Laundary Service</font><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                <input type="radio" name="srvce" value="medical" required><font size=4%>Medical Service</font><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                <input type="radio" name="srvce" value="Food" required><font size=4% >Food Service</font></div>    </div><br>
	<div> <div class="col-md-3"><font face="time new roman" size="4px">Date</font></div>                 <div><input type="date" placeholder="Enter date" name="date" required></div>                           </div><br>
    <div class="col-md-6"><center><input type="submit" value="Submit" name="submit"></center></div>
