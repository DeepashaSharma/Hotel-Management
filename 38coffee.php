...
<div>
 ...
 <div><font size="10" color="CC9933">COFFEE BREAKS</font></div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/112.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/113.jpg" width="460" height="345" id="one">
      </div>
...
The hotel's meeting spaces and dining options provide convenient and<br>
 ideal venues for meeting and entertaining, all under one roof. We ensure<br>
 that all of your Prague meetings and events will be memorable. Our <br>
 meeting rooms in Prague offer the same standard of elegance and <br>
 convenience as our guest rooms.
 </font>
   </div>
 </div>
