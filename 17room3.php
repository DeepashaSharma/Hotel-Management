...
<div>
 ...
 <div><font size="10" color="CC9933">ELVIS LUXURY SUITE</font></div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/37.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/38.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/39.jpg"  width="460" height="345" id="one">
      </div>
    
	<div class="item">
        <img src="images/40.jpg"  width="460" height="345" id="one">
      </div>
...
<br>
 ...
 <div>
   ...
   Our funky, one-bedroom Elvis Luxury Suite has a singular character all<br>
   on its own. Decorated in light and airy colors, guests can enjoy the suite's<br>
   cozy feel and unique layout. The Elvis Luxury Suite features two<br>
   bathrooms, a living room and a kitchenette, as well as a powerful<br>
   surround-sound audio system so guests can even dance the night away in<br>
   the privacy of their own suite. This Luxury Suite is NON-SMOKING.<br><br>

  Location : 2nd floor<br><br>

  View : Winter Garden Atrium<br><br>

 Decor : Bright crème, blue and pink tones, inspired by Italian design<br><br>
