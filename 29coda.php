...
<div>
 ...
 <div><font size="10" color="CC9933">CODA RESTAURANT</font></div>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/89.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/90.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/91.jpg"  width="460" height="345" id="one">
      </div>
...
<br>
 ...
 <div>
  ...
  Fine food and music form the perfect duet. CODA Restaurant is an ideal <br>
  place for a private lunch or a meeting and sits up to 30 people. Larger<br>
  groups can be accommodated in the adjacent Winter Garden Atrium, near<br>
  the piano and bar.<br><br>


 Be it a business lunch, festive dinner, or just a tasty snack – our Chef is <br>
 more than happy to compose a culinary symphony for you and your<br>
 guests.
 </font>
   </div>
 </div>
