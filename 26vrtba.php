...
<div>
 ...
 <div><font size="10" color="CC9933">VRTBA GARDEN</font></div>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/67.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/68.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/71.jpg"  width="460" height="345" id="one">
      </div>
	  
       <div class="item">
        <img src="images/75.jpg"  width="460" height="345" id="one">
      </div>
...
<br>
 ...
 The Vrtba Garden is Prague’s oldest Baroque garden and one of the<br>
 most charming and well-preserved places in Prague. This magnificent<br>
 landmark is also on the UNESCO World Heritage List.<br><br>


Take advantage of the private entrance offered to guests of the Aria Hotel<br>
 Prague, and explore the lovely terraced garden with a spectacular view of <br>
 the city. The garden is open from April through October. Private dining is <br>
 available at a surcharge upon request.<br><br>
 
 <hr>

Special opening hours: 10:00 – 21:30
