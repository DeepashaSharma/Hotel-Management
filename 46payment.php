<?php
  ...
  {	 
	...
	$sql = mysql_query("INSERT INTO payment(bank_name, card_type, pincode, valid_date, amount)
	VALUES ('$a','$b','$c','$d','$e')");
	 if($sql)
	 {  
    
	  echo "<script type='text/javascript'>
       alert('Your amount is submitted!!!!!!!!!!');
	   </script>";
...
<br><br>
 ...
 <div class="col-md-6">
  <form action="" method="POST">
     <font face="times new roman" size="9" color="CC9933">Payment</font><br><br>
 
  
<div> <div class="col-md-3"><font face="time new roman" size="4px">Bank name</font></div>      <div><input type="text" placeholder="Enter bank name" name="bn" required></div>        </div><br>
<div> <div class="col-md-3"><font face="time new roman" size="4px">Card type</font></div>      <div><input type="text" placeholder="Enter card type" name="ct" required></div>        </div><br>
<div> <div class="col-md-3"><font face="time new roman" size="4px">Pincode</font></div>        <div><input type="text" placeholder="Enter pincode" name="pc" required></div>          </div><br>
<div> <div class="col-md-3"><font face="time new roman" size="4px">Valid date</font></div>     <div><input type="date" placeholder="Enter valid date" name="vd" required></div>       </div><br>
<div> <div class="col-md-3"><font face="time new roman" size="4px">Amount</font></div>         <div><input type="text" placeholder="Enteramount" name="amunt" required></div>         </div><br>
 <div class="col-md-6"><center><input type="submit" value="Pay Amount" name="submit"></center></div>
 </form>
</div>
</div>
