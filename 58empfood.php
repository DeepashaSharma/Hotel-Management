<?php
  ...
  {	 
	...
	$sql = mysql_query("INSERT INTO foodserv(room_no, dish, date, charge)
	VALUES ('$a','$b','$c','$d')");
	 if($sql)
	 {  
    ...
    <!-- Wrapper for slides -->
	 <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/62.jpg"  width="80%" height="30%" id="one">
      </div>

      <div class="item">
        <img src="images/66.jpg" width="80%" height="30%" id="one">
      </div>
	  
      <div class="item">
        <img src="images/89.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/90.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/91.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/102.jpg" width="80%" height="30%" id="one">
      </div>
	 
	  <div class="item">
        <img src="images/114.jpg" width="80%" height="30%" id="one">
      </div>
...
<div class="col-md-4"></div>
 ...
 <form action="" method="POST">
  <font face="times new roman" size="9" color="CC9933">Food Services</font><br><br>
 ...
 <div> <div class="col-md-3"><font face="time new roman" size="4px">Dish</font></div>    <div><input type="text" placeholder="Enter dish" name="dis" required></div>               </div><br>
