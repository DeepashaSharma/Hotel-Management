...
<div>
 ...
 <div><font size="10" color="CC9933">BEETHOVEN LUXURY SUITE</font></div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/49.jpg"  width="460" height="345" id="one">
      </div>
      ...
      <div class="item">
        <img src="images/51.jpg"  width="460" height="345" id="one">
      </div>
	  
      <div class="item">
        <img src="images/52.jpg"  width="460" height="345" id="one">
      </div> 
	</div>
...
<br>
 ...
 <div>
  ...
  Our fantastic two-bedroom Beethoven Luxury Suite has been designed <br>
  very much for families. This Luxury Suite is decorated in an elegant<br>
  classical style and overlooks the beautiful UNESCO Vrtba Garden. A<br>
  separate living area, two bedrooms, three bathrooms and kitchenette are <br>
  included in the spacious layout. This Luxury Suite is NON-SMOKING.<br><br>

  Location : 3rd floor<br><br>

  View : Vrtba Garden<br><br>

  Decor : Crème and light yellow, inspired by Italian design<br><br>

  Beds : King and Twin<br><br>

  Bathrooms : One guest bathroom and two bathrooms with bathtub,<br>
