...
<div>
 ...
 <div><font size="10" color="CC9933">ROOFTOP TERRACE</font></div>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/86.jpg"  width="460" height="345" id="one">
      </div>

      <div class="item">
        <img src="images/87.jpg" width="460" height="345" id="one">
      </div>
    
      <div class="item">
        <img src="images/88.jpg"  width="460" height="345" id="one">
      </div>
...
<br>
 ...
 <div>
  ...
  Enjoy our world-class cuisine and beverage selection against the<br>
  magnificent backdrop of Prague. Our Terrace comfortably seats 36 guests,<br>
  but can also be rearranged to host cocktail parties for up to 60 people<br>
  upon request.<br><br>

 The Rooftop Terrace is open from April through October, weather<br>
 permitting.
 </font>
   </div>
 </div>
